 ...
 *	Youtube Link: https://youtu.be/0NqKp9Dgusg
 *  Exercise Description:
 *
 *  Our MAX is 0x78
 *  If the photo val is >= half of 0x78 then turn B0 on  (1)
 *  If the photo val is <  half of 0x78 then turn B0 off (0)
 *
...
void tick() {
    ...
    switch(state) {
        ...
        case on:
            ...
            photo = ADC;
            // on >= (0x78 / 2) or off < (0x78 / 2)  
            if (photo >= (0x78 / 2)) {
                tmpB = 0x01;
            } else if (photo < (0x78 / 2)) {
                tmpB = 0x00;
            }
