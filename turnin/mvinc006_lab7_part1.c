 ...
 *	Youtube Link: https://youtu.be/2hyIfpHctFA 
 *  Exercise Description:
 *
 *  Reads the 10bit ADC results from the ADC register and displays the results
 *  on 10 LEDs
 *
